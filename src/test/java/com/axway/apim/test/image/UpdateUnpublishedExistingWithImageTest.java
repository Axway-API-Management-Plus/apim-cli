...
public class UpdateUnpublishedExistingWithImageTest extends TestNGCitrusTestDesigner {
	...
	public void setupDevOrgTest() {
		...
		createVariable("configFile", "/com/axway/apim/test/files/image/1_no_image_flex_state.json");

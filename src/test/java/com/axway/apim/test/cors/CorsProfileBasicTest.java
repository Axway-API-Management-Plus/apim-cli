...
public class CorsProfileBasicTest extends TestNGCitrusTestDesigner {
	...
	public void setupDevOrgTest() {
		...
		createVariable("configFile", "/com/axway/apim/test/files/cors/1_api-with_default_cors.json");

...
| :---          | :---                 | :---:  | :--- |
| 7.7-20221130    | develop  |![Build Status](https://github.com/Axway-API-Management-Plus/apim-cli/actions/workflows/integration-test.yml/badge.svg)|Requires version >=1.13.2, Multi-Org supported from version 1.13.3|

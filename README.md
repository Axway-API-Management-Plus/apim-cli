...
![API-Manager Swagger-Promote overview]( https://github.com/Axway-API-Management-Plus/apimanager-swagger-promote/blob/master/modules/swagger-promote-core/src/lib/images/apimanager-swagger-promote-overview.png )

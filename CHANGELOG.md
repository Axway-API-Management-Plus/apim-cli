...
- apim.sh changed to improve support on Mac/Linux systems. Identifed by [@cbrowet-axway](https://github.com/cbrowet-axway) (See issue [#42](https://github.com/Axway-API-Management-Plus/apim-cli/issues/42)) Thanks to 
- Improving support for OpenAPI 3.x spec having not servers declared (See issue [#40](https://github.com/Axway-API-Management-Plus/apim-cli/issues/40))

...
- apim.sh changed to improve support on Mac/Linux systems (See issue [#42](https://github.com/Axway-API-Management-Plus/apim-cli/issues/42)) Thanks to @cbrowet-axway

...
```
    ...
    ./build_gw_image.py --license=../multiple.lic --default-cert --fed=$HOME/apim-cli/modules/apis/src/test/resources/apimanager/swagger-promote-7.7-20200130.fed --merge-dir $HOME/apim-cli/modules/apis/src/test/resources/apimanager/merge-dir/apigateway --out-image=api-gw-mgr:7.7-20200530
    docker images

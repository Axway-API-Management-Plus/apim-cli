...
public class SwaggerFromURLRefFileInConfigurationTestIT extends TestNGCitrusSpringSupport {
	...
	public void run() throws IOException {
        ...
        variable(ImportTestAction.API_DEFINITION,"./src/test/resources/com/axway/apim/test/files/basic/swagger-file-with-username.url");

...
public class CSVAPIExporterTest extends WiremockWrapper {
    ...
    @Test
    public void exportCSVWide() throws AppException {
        String[] args = {"-host", "localhost", "-id", "e4ded8c8-0a40-4b50-bc13-552fb7209150", "-t", "openapi", "-o", "csv", "-deleteTarget","-wide"};
        CLIOptions options = CLIAPIExportOptions.create(args);
        APIExportParams params = (APIExportParams) options.getParams();
        APIManagerAdapter.deleteInstance();
        APIManagerAdapter apiManagerAdapter = APIManagerAdapter.getInstance();
    ...
    @Test
    public void exportUltra() throws AppException {
        String[] args = {"-host", "localhost", "-id", "e4ded8c8-0a40-4b50-bc13-552fb7209150", "-t", "openapi", "-o", "csv", "-deleteTarget", "-ultra"};
        CLIOptions options = CLIAPIExportOptions.create(args);
        APIExportParams params = (APIExportParams) options.getParams();
        APIManagerAdapter.deleteInstance();
        APIManagerAdapter apiManagerAdapter = APIManagerAdapter.getInstance();

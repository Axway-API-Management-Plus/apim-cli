...
public class OutboundProfileTest {
    ...
    public void testDefaultValueRoute() throws AppException {
        ...
        Assert.assertTrue(actualProfile.equals(desiredProfile), "The route type of the outbound profiles are different.");
        ...
        Assert.assertTrue(actualProfile.equals(desiredProfile), "The Aroute type of the outbound profiles are different.");

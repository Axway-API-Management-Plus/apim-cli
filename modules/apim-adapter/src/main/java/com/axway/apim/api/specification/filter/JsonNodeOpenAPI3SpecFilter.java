...
import com.axway.apim.api.specification.filter.BaseAPISpecificationFilter.FilterConfig;
...
public class JsonNodeOpenAPI3SpecFilter {
    ...
    public static void filter(JsonNode openAPISpec, APISpecificationFilter filterConfig) {
        ...
        // that must be removed because they were not configured as included
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                if (filter.filterOperations(specPath, httpMethod, toList(tags))) {
                    ...
                    LOG.debug("Removed path/operation: {} / {}  and tags: {}", specPath, httpMethod, tags);
                }
            }
        }
        ...
        if (schemas != null) {
            ...
            while (modelNamesIt.hasNext()) {
                ...
                if (filter.filterModel(modelName)) {
                    ...
                    LOG.debug("Removed model: {} from API-Specification.",modelName);
                }
            }

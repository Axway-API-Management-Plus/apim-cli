...
public class App {
	...
	public static int run(String args[]) {
		try {
			...
			IAPI actualAPI = apimAdapter.getAPIManagerAPI(apimAdapter.getExistingAPI(desiredAPI.getPath(), null, desiredAPI.getVhost(), APIManagerAdapter.TYPE_FRONT_END, true), desiredAPI);

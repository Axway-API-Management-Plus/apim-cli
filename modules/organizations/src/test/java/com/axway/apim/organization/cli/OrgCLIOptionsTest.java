...
public class OrgCLIOptionsTest {
	...
	@Test
	public void testExportOrganizationParameters() throws ParseException, AppException {
	...
	@Test
	public void testDeleteOrganizationParameters() throws ParseException, AppException {
		String[] args = {"-s", "prod", "-n", "*My organization*", "-id", "UUID-ID-OF-THE-ORG", "-dev", "true"};

...
public class ImportCompleteApplicationTestIT extends TestNGCitrusTestRunner {
    ...
    public void importApplicationBasicTest(@Optional @CitrusResource TestContext context) throws InterruptedException {
        ...
        createVariable(TestParams.PARAM_CONFIGFILE, PACKAGE + "CompleteApplication.json");
...
//				.validate("$.restrictions[0].config.per", "1"));
        ...
        createVariable(TestParams.PARAM_EXPECTED_RC, "0");
        createVariable(TestParams.PARAM_CONFIGFILE, PACKAGE + "CompleteApplicationOnlyOneScope.json");
        importApp.doExecute(context);

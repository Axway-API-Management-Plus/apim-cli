...
@Test
public class ImportExportWithCustomPropsTestIT extends TestNGCitrusTestRunner {
    ...
    public void run(@Optional @CitrusResource TestContext context) throws IOException, AppException {
        ...
        createVariable(TestParams.PARAM_CONFIGFILE, PACKAGE + "AppWithCustomProperties.json");
